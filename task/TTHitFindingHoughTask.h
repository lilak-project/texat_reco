#ifndef TTHITFINDINGHOUGHTASK_HH
#define TTHITFINDINGHOUGHTASK_HH
 ...
 */
class TTHitFindingHoughTask : public LKTask
{
    public:
        TTHitFindingHoughTask();
        virtual ~TTHitFindingHoughTask() { ; }
    ...
    ClassDef(TTHitFindingHoughTask,1);
};
